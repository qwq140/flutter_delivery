...
import 'package:flutter_delivery/app/modules/user/repository/auth_repository.dart';
...
final userMeProvider = StateNotifierProvider<UserMeStateNotifier, UserModelBase?>((ref) {
  ...
  return UserMeStateNotifier(repository: userMeRepository, storage: storage, authRepository: authRepository);
});
...
class UserMeStateNotifier extends StateNotifier<UserModelBase?> {
  ...
  Future<UserModelBase> login(
    ...
    try {
      ...
      // 서버에서 날라온 에러메시지 넣기
      state = UserModelError(error: '로그인에 실패하였습니다.');
