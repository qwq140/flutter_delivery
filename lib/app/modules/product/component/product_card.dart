...
class ProductCard extends ConsumerWidget {
  ...
  factory ProductCard.fromRestaurantProductModel(
      {required RestaurantProductModel model, VoidCallback? onSubtract, VoidCallback? onAdd,}) {
    return ProductCard(
      id: model.id,
      image: Image.network(
        model.imgUrl,
    ...
    return Column(
      children: [
        ...
        if(onSubtract != null || onAdd != null)
          _Footer(
            total: (basket.firstWhere((e) => e.product.id == id).product.price * basket.firstWhere((e) => e.product.id == id).count).toString(),
